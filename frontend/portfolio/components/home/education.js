		...
		<div>
			...
			<div className="card">
				...
				<div className="card-content hidden" id="universityContent">
					<p>
						<b>BSc Computer Science: Distinction</b>
					</p>
					<a
						className="mt-3 mb-3"
						href="/documents/university_transcript.pdf"
						target="_blank"
					>
						Transcript
					</a>
					<p>
						In my final year I worked with KITC - an in-house consultancy firm
						supporting local businesses' online presence during the height of
						the pandemic
					</p>
				</div>
			</div>
