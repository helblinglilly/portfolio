			...
			<div className="pt-3" id="reductions">
				<div>
					<p className="inline-text">
						...
						of the day, week or month. My leadership skills often shine
						through as I suggest different strategies to ensure we are working
						as efficiently as possible given the fluctuating stock levels in
						the different areas. I value the team's input, critisism and we
