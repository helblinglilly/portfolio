...
RUN echo TWITTER_TOKEN=$TWITTER_TOKEN >> /usr/src/app/.env
RUN echo GA_KEY=$GA_KEY >> /usr/src/app/.env
RUN echo FETCHPREVIEW_TOKEN=$FETCHPREVIEW_TOKEN >> /usr/src/app/.env
