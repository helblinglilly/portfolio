        ...
        <div className="inline-flex gap-4">
          ...
          <div>
            <p>
              ...
              to create the other variations from.
              <br />
              Inspired by{" "}
              <a
                href="https://www.etsy.com/uk/shop/LeafItGreen"
                className="link"
              >
                LeafItGreen on etsy
              </a>
            ...
            <a
              href="https://static.helbling.uk/queer-inside/mainsheet.afdesign"
              className="link"
              download
            >
              mainsheet.afdesign (99kB)
            </a>
          </div>
        </div>
      </div>
          ...
          <div className="inline-flex gap-4" key={variation}>
            ...
            <div className="grid gap-2">
              {files[variation].files.map((filename) => {
                return (
                  <div className="grid md:inline-flex gap-2" key={filename}>
                    <a
                      href={`https://static.helbling.uk/queer-inside/${filename}.svg`}
                      className="link"
                      download
                    >
                      {filename}.svg
                    ...
                    <a
                      href={`https://static.helbling.uk/queer-inside/${filename}.png`}
                      className="link"
                      download
                    >
                      {filename}.png
